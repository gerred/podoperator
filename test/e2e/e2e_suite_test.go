...
var (
	...
	projectImage = "example.com/podoperator:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting podoperator integration test suite\n")
	RunSpecs(t, "e2e suite")
}

var _ = BeforeSuite(func() {
	// Disable Gomega output truncation to see full metrics output
	format.MaxLength = 0
